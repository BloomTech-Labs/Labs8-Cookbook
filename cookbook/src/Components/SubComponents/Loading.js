                ...
                <div class={this.state.animate ? "color-container is-animated" : "color-container"}>
                    ...
                    <svg id="transition-container" xmlns="http://www.w3.org/2000/svg" >
                        <g fill="none" fillRule="evenodd">
                            <path fill={this.state.colors[0]} d="M0 0h800v450H0z" />
                            <path fill={this.state.colors[1]} d="M0 0h800v450H0z" />
                            <path fill={this.state.colors[2]} d="M0 0h800v450H0z" />
                            <path fill={this.state.colors[3]} d="M0 0h800v450H0z" />
                            <path fill={this.state.colors[4]} d="M0 0h800v450H0z" />
